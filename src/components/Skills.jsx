...
const Skills = () => {
    ...
    return (
        ...
        >
            ...
            <Wrapper>
                {/* SKILL ICONS START */}
                <Div className="grid grid-cols-4 gap-3 md:grid-cols-5 relative">
                    <SkillIcon path={sk1} />
                    {/* <SkillIcon path={sk2} />
                    <SkillIcon path={sk3} />
                    <SkillIcon path={sk4} /> */}
                ...
                <div className="flex items-end justify-between flex-wrap-reverse py-[50px] md:py-[100px] relative">
                    ...
                    <div className="md:max-w-[65%] flex flex-col gap-6 md:gap-10">
                        <Service
                            ...
                            desc="Passionate Frontend Web Developer with hands-on experience in creating multiple websites. Eager to learn and grow in web development, continuously exploring new technologies to deliver user-friendly and dynamic interfaces. Seeking opportunities to contribute and expand expertise in the field."
                            data={[
                                "HTML",
                                "CSS",
                                "JavaScript",
                        ...
                        <Service
                            ...
                            desc="I am proficient in using a wide range of graphic design software, including Photoshop. Additionally, I've utilized online platforms like Canva and collaborative tools like Figma. These software tools have enabled me to create visually stunning designs across diverse mediums."
                            data={[
                                "Adobe Photoshop",
                                "Canva",
                                "Figma",
