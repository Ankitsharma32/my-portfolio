...
import man from "../assets/Ankit.png";
...
const HeroBanner = () => {
    ...
    return (
        <div
            id="hero"
            className="w-full h-[120vh] relative bg-[#111111] overflow-hidden"
        >
            ...
            <Wrapper>
                ...
                >
                    <div className="flex items-center gap-[6px]">
                        ...
                        <div>ankitsharma05203@gmail.com</div>
                    </div>
                    <ul className="flex 2xl:text-[20px]">
                        <li
                            className="cursor-pointer px-5 py-2 hover:bg-slate-800 transition active:scale-90 rounded-lg"
                        ...
                        <li
                            className="cursor-pointer px-5 py-2 hover:bg-slate-900 transition active:scale-90 rounded-lg"         
                        > 
                        <a href="https://docs.google.com/document/d/10u1aoDJKAyKLzeTUB4w2Z_6O9Ceaa_jR/edit?usp=sharing&ouid=116443928168779746392&rtpof=true&sd=true">Resume</a>
                        </li>
                        <li
                            className="cursor-pointer px-5 py-2 hover:bg-slate-900 transition active:scale-90 rounded-lg"
                ...
                >
                    <div className="font-light mb-4">
                        👋 Hi, I Am{" "}
                        <span className="font-semibold">Ankit Sharma</span>
                    </div>
                    <b>A Software Engineer based in Mumbai. <br /> I develop applications that help us get more out of lif <br />e and work.</b><br />
                    
                    {/* <div className="max-w-[510px]">
                        I create and websites.
                    </div> */}
                </motion.div>
                {/* INTRO END */}
